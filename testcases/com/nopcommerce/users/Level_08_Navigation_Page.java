...
public class Level_08_Navigation_Page extends BaseTest {
    //Pre_Condition
    @Parameters("browser")
    @BeforeClass
    ...
    public void User_04_Switch_Page() {
        adressesPage = customerPage.openAdressesPage();
        //.....

        orderPage = adressesPage.openOrderPage();
        ///.......

        rewardPointPage = orderPage.openRewardPoint();
        ///.....
